<template>
        ...
        <div class="flex items-center">
          <svg class="dark:fill-white" height="20" width="14" xmlns="http://www.w3.org/2000/svg">
          ...
          <p class="ml-4 text-cyan-blue-800 text-sm">San Francisco</p>
        </div>
        <div class="flex items-center">
          <svg class="opacity-50 dark:fill-white dark:opacity-50" height="18" width="20" xmlns="http://www.w3.org/2000/svg">
          ...
          <p class="ml-4 text-cyan-blue-800 text-sm opacity-50 dark:text-white dark:opacity-50">Not Available</p>
        </div>
        <div class="flex items-center">
          <svg class="dark:fill-white" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
            <g class="fill-cyan-blue-800 dark:fill-white">
          ...
          <a class="ml-4 text-cyan-blue-800 text-sm hover:underline" href="https://github.blog" target="_blank">https://github.blog</a>
        </div>
        <div class="flex items-center">
          <svg hclass="dark:fill-white" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
            <g class="fill-cyan-blue-800 dark:fill-white">
          ...
          <p class="ml-4 text-cyan-blue-800 text-sm">@github</p>
        </div>
      </div>
</template>