...
<template>
  <div class="grid grid-cols-2 gap-x-5 gap-y-[15px] mt-9 dark:text-white">
    <div class="flex items-center">
      <svg class="fill-cyan-blue-800 dark:fill-white" :class="{'opacity-50 dark:opacity-50' : !location}" height="20" width="14" xmlns="http://www.w3.org/2000/svg">
      ...
      <p class="ml-4 text-cyan-blue-800 text-sm dark:text-white" :class="{'opacity-50 dark:opacity-50' : !location}">{{ location ? location : "Not Available" }}</p>
    </div>
    <div class="flex items-center">
      <svg class="fill-cyan-blue-800 dark:fill-white" :class="{'opacity-50 dark:opacity-50' : !twitter}" height="18" width="20" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex items-center">
      <svg class="fill-cyan-blue-800 dark:fill-white" :class="{'opacity-50 dark:opacity-50' : !blog}" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
        <g class="fill-cyan-blue-800 dark:fill-white" :class="{'opacity-50 dark:opacity-50' : !blog}">
    ...
    <div class="flex items-center">
      <svg class="fill-cyan-blue-800 dark:fill-white" :class="{'opacity-50 dark:opacity-50' : !company}" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
        <g class="fill-cyan-blue-800 dark:fill-white" :class="{'opacity-50 dark:opacity-50' : !company}">
