...
<template>
  <div class="grid grid-cols-1 gap-y-4 mt-9 md:grid-cols-2 md:gap-x-10 md:gap-y-[15px] dark:text-white">
    <div class="flex items-center">
      ...
      <p class="ml-4 text-cyan-blue-800 text-xs md:text-sm dark:text-white" :class="{'opacity-50 dark:opacity-50' : !location}">{{ location ? location : "Not Available" }}</p>
    </div>
    <div class="flex items-center">
      ...
      <a 
        class="ml-4 text-cyan-blue-800 text-xs md:text-sm dark:text-white hover:underline"
